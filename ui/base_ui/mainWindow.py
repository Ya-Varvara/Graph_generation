...
"}")
        ...
        self.label_folder_name = QtWidgets.QLabel(self.gridLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_folder_name.setMinimumSize(QtCore.QSize(220, 40))
        self.label_folder_name.setMaximumSize(QtCore.QSize(220, 40))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(12)
        ...
        self.folder_name = QtWidgets.QLineEdit(self.gridLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.folder_name.setMaximumSize(QtCore.QSize(60, 23))
        ...
        self.close_graph_frame_btn.setGeometry(QtCore.QRect(634, 435, 120, 35))
        ...
        self.delete_graph_btn = QtWidgets.QPushButton(self.graph_widget)
        self.delete_graph_btn.setGeometry(QtCore.QRect(505, 435, 120, 35))
        self.delete_graph_btn.setMinimumSize(QtCore.QSize(0, 0))
        self.delete_graph_btn.setMaximumSize(QtCore.QSize(300, 50))
        self.delete_graph_btn.setObjectName("delete_graph_btn")
        ...
        self.delete_folder_btn.setGeometry(QtCore.QRect(450, 30, 140, 40))
        ...
        self.my_folders_widget.raise_()
        self.generation_widget.raise_()
        self.my_graphs_widget.raise_()
    ...
    def retranslateUi(self, main_window):
        ...
        self.delete_graph_btn.setText(_translate("main_window", "Удалить граф"))
